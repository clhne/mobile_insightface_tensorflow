...
def get_parser():
    ...
    parser.add_argument('--eval_db_path', default='/workspace_ssd/chenglinlu/face_recognition/dataset/faces_ms1m_112x112', help='evluate datasets base path')
    parser.add_argument('--eval_nrof_folds', type=int,
                        help='Number of folds to use for cross validation. Mainly used for testing.', default=10)
    parser.add_argument('--tfrecords_file_path', default='/workspace_ssd/chenglinlu/face_recognition/dataset/faces_ms1m_112x112', type=str,
            ...
            while True:
                try:
                    ...
                    if count > 0 and count % args.show_info_interval == 0:
                        print('[%s]epoch %d, total_step %d, total loss is %.2f , '
                              'training accuracy is %.6f, time %.3f samples/sec' %
                              (datetime.now(),i, count, total_loss_val, acc_val, pre_sec))
