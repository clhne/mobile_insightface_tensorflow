...
def get_parser():
    ...
    parser.add_argument('--eval_db_path', default='/workspace/chenglinlu/fr/dataset/faces_ms1m_112x112', help='evluate datasets base path')
    parser.add_argument('--eval_nrof_folds', type=int,
                        help='Number of folds to use for cross validation. Mainly used for testing.', default=10)
    parser.add_argument('--tfrecords_file_path', default='/workspace/chenglinlu/fr/dataset/faces_ms1m_112x112', type=str,
